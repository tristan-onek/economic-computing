...
# Create homoscedastic errors (constant variance)
...
# Plot residuals vs fitted values to visualize homoscedasticity
...
# Perform a Breusch-Pagan test for homoscedasticity
